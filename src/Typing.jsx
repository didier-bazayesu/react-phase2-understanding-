...
export   const words = [
       ...
       "less", "let", "letter", "level", "life", "light", "like", "likely", "line", "list",
       "listen", "little", "live", "local", "long", "look", "lose", "loss", "lot", "love",
       "low", "machine", "magazine", "main", "maintain", "major", "majority", "make", "man", "manage",
       ...
       "new", "news", "newspaper", "next", "nice", "night", "no", "none", "nor", "north",
...
function Typing() {
    ...
    function getRandomText(count = 20) {
        ...
        <div>
            <p>
                {text.split("").map((char, index) => {
                    ...
                    return <span  className= "size" key={index} style={{ color }}>{char}</span>;
                })}
            </p>
